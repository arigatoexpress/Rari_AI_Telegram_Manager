...
bucket_name = f"gs://{project_id}-bd-analytics-agent-logs-data"
...
app.title = "bd-analytics-agent"
app.description = "API for interacting with the Agent bd-analytics-agent"
