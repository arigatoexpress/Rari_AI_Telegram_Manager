...
vector_search_index = os.getenv(
    "VECTOR_SEARCH_INDEX", "bd-analytics-agent-vector-search"
)
vector_search_index_endpoint = os.getenv(
    "VECTOR_SEARCH_INDEX_ENDPOINT", "bd-analytics-agent-vector-search-endpoint"
)
vector_search_bucket = os.getenv(
    "VECTOR_SEARCH_BUCKET", f"{project_id}-bd-analytics-agent-vs"
)
